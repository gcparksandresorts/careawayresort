...
footer.innerHTML = "<div id='footerLinks'> \
				...
				<div><h4>Resorts & Destinations</h4><a href='"+siteLink+"destinations/careaway-park'>Globe-City's Careaway Park</a><a href='"+siteLink+"destinations/port-of-adventure'>Globe-City Port of Adventure</a><a href='"+siteLink+"destinations/splashport-bay'>Globe-City Splashport Bay</a> <a>Shops & More District</a> <a>Globe-City's Enchanted Lodge Resort</a><a>Globe-City World of Wonder</a><a>The RW Hotel</a><a>MCR Port of Palms Resort</a><a>MCR Splashport Hotel</a></div> \
				<div><h4>Tickets & Passes</h4> <a href='"+siteLink+"tickets'>Park Tickets</a> <a href='"+siteLink+"tickets/annual-passports'>Annual Passports</a> <a href='"+siteLink+"tickets/gcvip'>GC VIP Tickets</a> <a>Vacation Packages</a> <a>Group Admission</a> <a>Promotions & Discounts</a></div> \
