...
header.innerHTML = "<div id='headerBkg'></div><div id='headerBar'><div id='hbContent'><img id='headerLogo' onclick='"+'window.open("https://gcparksandresorts.github.io/careawayresort/","_self")'+"'src='https://gcparksandresorts.github.io/careawayresort/files/images/logos/careawayresort-logo.png'> \
			...
			<div id='hbSideMenu' class=''><a class='btn' href='"+siteLink+"tickets'>Tickets and Passes</a> \
				<a onclick='document.getElementById("+'"hbIntd1"'+").classList.toggle("+'"open"'+");'>&#11206; Things to Do</a> <div id='hbIntd1' class='hbSMsubMen'> <a href='"+siteLink+"#destinationSection'>Destinations</a> <a href='"+siteLink+"things-to-do/attractions'>Attractions & Entertainment</a> <a href='"+siteLink+"things-to-do/dining'>Restaurants and Dining</a> <a>Shopping</a> <a>Recreation</a></div> \
			...
			<div id='ttdbarMenu' class='barMenu'> \
				<div id='leftSection'> \
					...
					<div> <img class='rsBackground' src='https://gcparksandresorts.github.io/gcresorthighland/webresources/images/tts3.jpg'> <div class='rsHider'></div> <img class='rsIcon' src='https://aztechadmit.github.io/visitpn/files/images/menuIcons/menuIcon.png'> <h4>Attractions & Entertainment</h4> <a href='"+siteLink+"things-to-do/attractions'></a> </div> \
