...
function populatePage(){
    ...
    // Populate menu
    menuContainer.innerHTML = "<label for='menuSelector'>Select Menu:</label> <select id='menuSelector' onchange='changeMenu(this.value)'></select>";
        ...
        if(restaurantBreakfast[0] != 'empty'){
            ...
            for(i=0; i<restaurantBreakfast.length; i++){
                ...
                if(temp[0] == 'new'){ // new category
                    ...
                    tempContainer.innerHTML += "<h3>"+temp[1]+"</h3>" + temp[2];
                }
            }
        }
