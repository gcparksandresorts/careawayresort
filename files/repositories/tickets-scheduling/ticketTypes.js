...
// TikAddOnArray[NUM] = "Name0 | PerTicket1 | PerDay2 | restrictType3,all | restrictCategory4,all | t1Price,t2Price,t3Price,t4Price,t5Price | Description6 | ImgLink7";
    ...
    TikAddOnArray[0] = "Daily Theme-Park Parking | no | yes | day-ticket,all | none | 20,20,25,25,29 | $30 value. Includes parking at theme-park parking lots for one vehicle for one operating day. Parking is valid for one day only. Does not include valet or preffered parking. | https://i.imgur.com/z8dFKDp.png";
    ...
    TikAddOnArray[3] = "Daiy Locker Rental - Large | no | yes | day-ticket,all | none | 15,15,15,15,15 | Includes a large locker rental for one operating day. Locker is valid for one day only, guests with multiple-days wil need to clear out their locker at the end of each day. | imgLink";
