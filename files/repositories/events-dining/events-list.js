...
// HALLOWEEN SEASON
iter+=1; eventlistArray[iter] = "halloween | Halloween at the Careaway Resort | Seasonal Event | 0 | clickLink4 | show/Delight in colorful decorations throughout the resort, seasonal food offerings, and new entertainment. It's super spooky fun! | 0 | eventImg7";
...
// SUMMER SEASON
iter+=1; eventlistArray[iter] = "stars | Stars & Splashes at Splashport Bay | eventHours2 | 3 | clickLink4 | show/description5 | admission6 | eventImg7";
iter+=1; eventlistArray[iter] = "wos | Waves of Summer | 6:00 PM - 9:00 PM | 7 | clickLink4 | show/Enjoy the summer evenings under the stars at the lawn of the MCR WAVES Resort. Stop by for chill 80s summer night jams, refreshing beverages and cocktails, savory snacks, and an ambient-lit dance floor | 0 | eventImg7";
iter+=1; eventlistArray[iter] = "eventCode0 | eventName1 | eventHours2 | eventLocation3 | clickLink4 | show/description5 | admission6 | eventImg7";
...
iter+=1; eventlistArray[iter] = "roovBday | Founder's Day - Reuven's Birthday! | eventHours2 | 1 | clickLink4 | show/description5 | 1 | eventImg7";
